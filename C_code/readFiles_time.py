...
def recordSound():
    ...
    # a length of 123496
    #recArray1, fs = sf.read("Audio/dichtste_speech.wav")
    #recArray2, fs = sf.read("Audio/ver_speech.wav")
    #recArray3, fs = sf.read("Audio/verder_speech.wav")
    #recArray4, fs = sf.read("Audio/verste_speech.wav")
    #recArray5, fs = sf.read("Audio/error_speech.wav")
