classdef Application_ANC < matlab.apps.AppBase
...
%--------------------------------------------------------------------------------------------------------------------            
            ...
            if domain == "Time domain" 
                ...
                % Spectrogram error
                [signal_error_STFT, L_time_frames, frequencies] = ANC_time_to_TF(error_mic, fs_pn);
                imagesc(app.sem, 1:L_time_frames, frequencies, mag2db(abs(signal_error_STFT(:,:,1))), [-65, 20]);
                
                % Spectrogram loudspeaker_noise
                [signal_loudspeaker_noise_STFT, L_time_frames, frequencies] = ANC_time_to_TF(loudspeaker_noise, fs_pn);
...
%--------------------------------------------------------------------------------------------------------------------              
            ...
            [signal_STFT, L_time_frames, frequencies] = ANC_time_to_TF(noise(:,1), fs_pn);
...
%-------------------------------------------------------------------------------------------------------------------- 
            ...
            % Spectrogram
            [signal_STFT, L_time_frames, frequencies] = ANC_time_to_TF(errorsig, fs_pn);
